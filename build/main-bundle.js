...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__containers_App__ = __webpack_require__(39);




class ContactsApp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
	}

	render() {
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__containers_App__["a" /* App */], null);
	}
}

__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ContactsApp, null), document.getElementById('app'));
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(19);var warning=__webpack_require__(20);var ExecutionEnvironment=__webpack_require__(11);var _assign=__webpack_require__(12);var emptyFunction$1=__webpack_require__(2);var EventListener=__webpack_require__(13);var getActiveElement=__webpack_require__(14);var shallowEqual=__webpack_require__(15);var containsNode=__webpack_require__(16);var focusNode=__webpack_require__(17);var emptyObject=__webpack_require__(18);var checkPropTypes=__webpack_require__(33);var hyphenateStyleName=__webpack_require__(35);var camelizeStyleName=__webpack_require__(37);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ContactList__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FormApp__ = __webpack_require__(45);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	componentDidMount() {
		...
		const peopleList = [{ id: 1525207676771, first_name: "Ed", last_name: "Wince", address: "755 South Lafayette Dr." }, { id: 1525207680217, first_name: "Paul", last_name: "Webber", address: "599 Excalibur Dr." }];
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__FormApp__["a" /* FormApp */], { firstName: this.state.firstName, lastName: this.state.lastName, address: this.state.address, contactId: this.state.contactId, onSubmit: this.handleSubmit, onChange: this.handleChange })
				)
			)
		);
	}
...
const ContactList = props => {
	return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
		'ul',
		null,
		props.contacts.map(result => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			'li',
			{ key: result.id },
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'h3',
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'button',
					{ type: 'button', className: 'button small left', onClick: props.handleEdit, 'data-typeid': result.id },
					'Edit'
				),
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'button',
					{ type: 'button', className: 'button small right alert', onClick: props.handleRemove, 'data-typeid': result.id },
					'Remove'
				)
			)
		))
...
ContactList.propTypes = {
	contacts: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array.isRequired
};
...
class FormApp extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	constructor(props) {
		super(props);
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', name: 'firstName', id: 'firstName', onChange: this.handleChange, value: this.props.firstName })
				)
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', name: 'lastName', id: 'lastName', onChange: this.handleChange, value: this.props.lastName })
				)
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'text', name: 'address', id: 'address', onChange: this.handleChange, value: this.props.address })
				)
			),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'hidden', name: 'contactId', value: this.props.contactId }),
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'button',
...
/* harmony export (immutable) */ __webpack_exports__["a"] = FormApp;
...
FormApp.propTypes = {
	...
	contactId: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number.isRequired,
